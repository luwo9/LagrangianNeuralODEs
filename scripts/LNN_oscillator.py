"""
This script trains a Lagrangian Neural Network (LNN) [1]_ (a Lagrangian
Neural ODE with Euler-Lagrange equation by construction) on a toy
dataset of a harmonic oscillator.
...
# fmt: off
c = 0.9 * omega**2 * 0
spring_matrix = np.array([[omega**2+c, -c],
                          [-c, omega**2+c]])
...
def main():
    ...
    x_data, xdot_data, xdotdot_data = from_ode(oscillator, t_data, x_0, v_0)
    ...
    t_plot = np.linspace(0, 2, 1000)  # Higher resolution for curves
